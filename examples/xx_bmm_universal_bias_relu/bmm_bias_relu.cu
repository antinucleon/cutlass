...
using BMMInstance =
    Operation_cutlass_tensorop_f16_s16816gemm_f16_128x128_32x3_tn_align8;
...
int main(int argc, char** argv) {
  ...
  for (int i = 0; i < 5; ++i) {
    bmm((cutlass::half_t*)a.device_data(), (cutlass::half_t*)b.device_data(),
        (cutlass::half_t*)c.device_data(), &a_dim0, &a_dim1, &a_dim2, &b_dim0,
        &b_dim1, &b_dim2, &c_dim0, &c_dim1, &c_dim2);
  }
